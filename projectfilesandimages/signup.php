...
function valid($num)
{
	...
	if(strlen($fil_num)>9 and strlen($fil_num)<14)
	{
		return true;
	}
	else
...
if($p1==$p2 and $p1!="" and valid($num) and validated($p1) and isset($_POST['submit']))
{
